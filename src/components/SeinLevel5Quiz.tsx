...
const QUESTIONS: Question[] = [
  { id: 1, text: 'I am', answer: 'ich bin' },
  { id: 2, text: 'You are (informal)', answer: 'du bist' },
  { id: 3, text: 'He is', answer: 'er ist' },
  { id: 4, text: 'She is', answer: 'sie ist' },
  { id: 5, text: 'It is', answer: 'es ist' },
  { id: 6, text: 'We are', answer: 'wir sind' },
  { id: 7, text: 'You are (formal)', answer: 'Sie sind' },
  { id: 8, text: 'They are', answer: 'sie sind' },
  { id: 9, text: 'You all are', answer: 'ihr seid' },
  { id: 10, text: 'One is', answer: 'man ist' },
];

export default function SeinLevel5Quiz({ onBack }: { onBack: (passed?: boolean) => void }) {
      ...
      <div className="bg-white border-2 border-gray-100 rounded-2xl shadow-sm p-6 md:p-10 relative">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-bold text-gray-400 uppercase tracking-widest">Wähle deine Muttersprache:</label>
            <div className="bg-gray-50 border border-gray-200 text-black font-bold px-4 py-3 rounded-xl w-fit">
              Englisch
            </div>
          </div>

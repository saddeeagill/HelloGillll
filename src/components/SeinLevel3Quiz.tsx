...
const QUESTIONS: Question[] = [
  { id: 1, verb: 'bin', answer: 'ich' },
  { id: 2, verb: 'bist', answer: 'du' },
  { id: 3, verb: 'ist', answer: 'er/sie/es/man' },
  { id: 4, verb: 'ist', answer: 'er/sie/es/man' },
  { id: 5, verb: 'ist', answer: 'er/sie/es/man' },
  { id: 6, verb: 'ist', answer: 'er/sie/es/man' },
  { id: 7, verb: 'sind', answer: 'wir/sie/Sie' },
  { id: 8, verb: 'sind', answer: 'wir/sie/Sie' },
  { id: 9, verb: 'sind', answer: 'wir/sie/Sie' },
  { id: 10, verb: 'seid', answer: 'ihr' },
];

const getValidAnswers = (verb: string) => {
  if (verb === 'bin') return ['ich'];
  if (verb === 'bist') return ['du'];
  if (verb === 'ist') return ['er', 'sie', 'es', 'man'];
  if (verb === 'sind') return ['wir', 'sie']; // 'sie' covers both plural and formal when lowercased
  if (verb === 'seid') return ['ihr'];
  return [];
};

export default function SeinLevel3Quiz({ onBack }: { onBack: (passed?: boolean) => void }) {
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-2xl mx-auto pb-20 px-4 md:px-0 pt-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg font-medium text-gray-500">Konjugation zu Person</p>
      </div>

...
const QUESTIONS: Question[] = [
  { id: 1, noun: 'Familie', predicate: 'im Urlaub.', answer: 'ist' },
  { id: 2, noun: 'Gäste', predicate: 'im Restaurant.', answer: 'sind' },
  { id: 3, noun: 'Mutter', predicate: 'drei Kinder.', answer: 'hat' },
  { id: 4, noun: 'Uhr', predicate: 'kaputt.', answer: 'ist' },
  { id: 5, noun: 'Bus', predicate: 'pünktlich.', answer: 'ist' },
  { id: 6, noun: 'Freunde', predicate: 'eine Idee.', answer: 'haben' },
  { id: 7, noun: 'Wohnung', predicate: 'gross.', answer: 'ist' },
  { id: 8, noun: 'Kinder', predicate: 'im Garten.', answer: 'sind' },
  { id: 9, noun: 'Mann', predicate: 'ein Problem.', answer: 'hat' },
  { id: 10, noun: 'CafÃ©', predicate: 'geöffnet.', answer: 'ist' },
];

export default function NounLevel4Quiz({ onBack }: { onBack: (passed?: boolean) => void }) {
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-2xl mx-auto pb-20 px-4 md:px-0 pt-8">
      ...
      <div className="mb-8">
        <h3 className="text-xl font-bold text-black mb-1">Level 4</h3>
        <p className="text-lg font-medium text-gray-500">Alltagssituationen (Zeit, Ort, Familie, Gefühle)</p>
      </div>

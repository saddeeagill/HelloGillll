...
const QUESTIONS: Question[] = [
  { id: 1, pronoun: 'er', answer: 'ist' },
  { id: 2, pronoun: 'wir', answer: 'sind' },
  { id: 3, pronoun: 'ich', answer: 'bin' },
  { id: 4, pronoun: 'sie (they)', answer: 'sind' },
  { id: 5, pronoun: 'du', answer: 'bist' },
  { id: 6, pronoun: 'man', answer: 'ist' },
  { id: 7, pronoun: 'ihr', answer: 'seid' },
  { id: 8, pronoun: 'es', answer: 'ist' },
  { id: 9, pronoun: 'Sie (formal)', answer: 'sind' },
  { id: 10, pronoun: 'sie (she)', answer: 'ist' },
];

export default function SeinLevel2Quiz({ onBack }: { onBack: (passed?: boolean) => void }) {
            ...
            {QUESTIONS.map((q, index) => {
              ...
              return (
                <div key={q.id} className="bg-white border-2 border-gray-100 rounded-2xl p-6 shadow-sm">
                  ...
                  <div className="text-2xl font-black text-black mb-6">{q.pronoun} ______</div>
      ...
      <div className="bg-white border-2 border-gray-100 rounded-2xl shadow-sm p-6 md:p-10 relative">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          <div className="flex items-center gap-4 text-4xl font-black text-black">
            <span>{currentQ.pronoun} ______</span>
          </div>

...
const POOL = [
  { text: 'ich ___', answer: 'habe' },
  { text: 'du ___', answer: 'hast' },
  { text: 'er ___', answer: 'hat' },
  { text: 'sie (Sg.) ___', answer: 'hat' },
  { text: 'es ___', answer: 'hat' },
  { text: 'wir ___', answer: 'haben' },
  { text: 'ihr ___', answer: 'habt' },
  { text: 'sie (Pl.) ___', answer: 'haben' },
  { text: 'Sie (formal) ___', answer: 'haben' },
  { text: 'man ___', answer: 'hat' },
];
...
export default function HabenLevel1Quiz({ onBack }: { onBack: (passed?: boolean) => void }) {
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-2xl mx-auto pb-20 px-4 md:px-0 pt-8">
      ...
      <div className="mb-8">
        <h3 className="text-xl font-bold text-black mb-1">Level 1: Personentabelle</h3>
      </div>
      ...
      <div className="bg-white border-2 border-gray-100 rounded-2xl shadow-sm p-6 md:p-10 relative">
        <div className="flex justify-between items-center mb-8">
          ...
          <span className="text-sm font-bold text-black bg-gray-100 px-3 py-1 rounded-full">Level: 1</span>
        </div>

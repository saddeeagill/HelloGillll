...
const POOL = [
  { text: 'ich ___', answer: 'bin' },
  { text: 'du ___', answer: 'bist' },
  { text: 'er ___', answer: 'ist' },
  { text: 'sie (Sg.) ___', answer: 'ist' },
  { text: 'es ___', answer: 'ist' },
  { text: 'wir ___', answer: 'sind' },
  { text: 'ihr ___', answer: 'seid' },
  { text: 'sie (Pl.) ___', answer: 'sind' },
  { text: 'Sie (formal) ___', answer: 'sind' },
  { text: 'man ___', answer: 'ist' },
];

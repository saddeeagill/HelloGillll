...
const QUESTIONS: Question[] = [
  { id: 1, pronoun: 'ich', answer: 'bin' },
  { id: 2, pronoun: 'du', answer: 'bist' },
  { id: 3, pronoun: 'er', answer: 'ist' },
  { id: 4, pronoun: 'sie (she)', answer: 'ist' },
  { id: 5, pronoun: 'es', answer: 'ist' },
  { id: 6, pronoun: 'man', answer: 'ist' },
  { id: 7, pronoun: 'Sie (formal)', answer: 'sind' },
  { id: 8, pronoun: 'wir', answer: 'sind' },
  { id: 9, pronoun: 'sie (they)', answer: 'sind' },
  { id: 10, pronoun: 'ihr', answer: 'seid' },
];

export default function SeinLevel1Quiz({ onBack }: { onBack: (passed?: boolean) => void }) {
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-2xl mx-auto pb-20 px-4 md:px-0 pt-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg font-medium text-gray-500">Personentabelle</p>
      </div>

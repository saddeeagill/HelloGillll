...
const QUESTIONS: Question[] = [
  { id: 1, verb: 'haben', answer: 'wir/sie/Sie' },
  { id: 2, verb: 'habe', answer: 'ich' },
  { id: 3, verb: 'hat', answer: 'er/sie/es/man' },
  { id: 4, verb: 'hast', answer: 'du' },
  { id: 5, verb: 'habt', answer: 'ihr' },
  { id: 6, verb: 'haben', answer: 'wir/sie/Sie' },
  { id: 7, verb: 'hat', answer: 'er/sie/es/man' },
  { id: 8, verb: 'haben', answer: 'wir/sie/Sie' },
  { id: 9, verb: 'hat', answer: 'er/sie/es/man' },
  { id: 10, verb: 'hat', answer: 'er/sie/es/man' },
];

const getValidAnswers = (verb: string) => {
  if (verb === 'habe') return ['ich'];
  if (verb === 'hast') return ['du'];
  if (verb === 'hat') return ['er', 'sie', 'es', 'man'];
  if (verb === 'haben') return ['wir', 'sie'];
  if (verb === 'habt') return ['ihr'];
  return [];
};

export default function HabenLevel4Quiz({ onBack }: { onBack: (passed?: boolean) => void }) {
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-2xl mx-auto pb-20 px-4 md:px-0 pt-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg font-medium text-gray-500">Gemischte Konjugation</p>
      </div>

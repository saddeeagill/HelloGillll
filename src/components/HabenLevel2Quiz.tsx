...
const QUESTIONS: Question[] = [
  { id: 1, pronoun: 'he', answer: 'has' },
  { id: 2, pronoun: 'we', answer: 'have' },
  { id: 3, pronoun: 'I', answer: 'have' },
  { id: 4, pronoun: 'they', answer: 'have' },
  { id: 5, pronoun: 'you', answer: 'you have' },
  { id: 6, pronoun: 'man', answer: 'has' },
  { id: 7, pronoun: 'her', answer: 'have' },
  { id: 8, pronoun: 'it', answer: 'has' },
  { id: 9, pronoun: 'They (formally)', answer: 'have' },
  { id: 10, pronoun: 'she', answer: 'has' },
];

export default function HabenLevel2Quiz({ onBack }: { onBack: (passed?: boolean) => void }) {
            ...
            {QUESTIONS.map((q, index) => {
              ...
              return (
                <div key={q.id} className="bg-white border-2 border-gray-100 rounded-2xl p-6 shadow-sm">
                  ...
                  <div className="text-2xl font-black text-black mb-6">{q.pronoun}</div>
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-2xl mx-auto pb-20 px-4 md:px-0 pt-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg font-medium text-gray-500">Gemischte Personen</p>
      </div>
      ...
      <div className="bg-white border-2 border-gray-100 rounded-2xl shadow-sm p-6 md:p-10 relative">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          <div className="flex items-center gap-4 text-4xl font-black text-black">
            <span>{currentQ.pronoun} {currentQ.pronoun === 'they' || currentQ.pronoun === 'she' ? '' : '______'}</span>
          </div>
